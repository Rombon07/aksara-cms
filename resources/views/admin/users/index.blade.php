            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 border-b border-gray-200 flex justify-between items-center">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Manage all users and their roles in the system.</p>
                    </div>
                    <div>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @elseif($user->role === 'editor')
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">Editor</span>
                                        @elseif($user->role === 'author')
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">Author</span>
                                        @else

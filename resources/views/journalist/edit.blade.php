                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('journalist.update', $article) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500" id="title" type="text" name="title" value="{{ old('title', $article->title) }}" required>
                        </div>
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2" for="thumbnail">Thumbnail Image (Leave blank to keep current)</label>
                            @if($article->thumbnail)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($article->thumbnail) }}" alt="Thumbnail" class="h-32 rounded">
                                </div>
                            @endif

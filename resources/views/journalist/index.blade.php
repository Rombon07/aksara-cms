                                    ...
                                    <tr>
                                        <td class="px-6 py-4">
                                            ...
                                            @if($article->editor_notes && $article->status === 'draft')
                                                <div class="text-xs text-red-600 mt-1"><strong>Editor Note:</strong> {{ $article->editor_notes }}</div>
                                            @endif
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('journalist.edit', $article) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>

...
<div class="bg-indigo-700 pb-24">
    <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div class="text-center">
            <h1 class="text-4xl font-extrabold text-white sm:text-5xl sm:tracking-tight lg:text-6xl">Search Results</h1>
            <p class="max-w-xl mt-5 mx-auto text-xl text-indigo-200">Found {{ $articles->total() }} articles matching "{{ $q }}"</p>
        </div>
    </div>
</div>
...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-24 pb-12">
    ...
    @else
        <div class="text-center py-20 bg-white rounded-2xl border border-gray-100 shadow">
            <h3 class="mt-2 text-sm font-medium text-gray-900">No matching articles found</h3>
            <p class="mt-1 text-sm text-gray-500">Try searching with a different keyword.</p>
        </div>
    @endif
</section>
@endsection
